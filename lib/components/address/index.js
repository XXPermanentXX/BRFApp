    ...
    return html`
      <div class="Address">
        <div class="Form-collapse">
          ${input({ label: __('Address'), className: 'Address-street', required: true, name: 'address', value: this.address || '', autocomplete: 'street-address', oninput: oninput })}
          ${input({ label: __('Postnummer'), className: 'Address-postalCode', required: true, name: 'postalCode', value: this.postalCode || '', autocomplete: 'postal-code', oninput: oninput })}
          ${input({ label: __('Ort'), className: 'Address-postalTown', required: true, name: 'postalTown', value: this.postalTown || '', autocomplete: 'address-level2', oninput: oninput })}
        </div>

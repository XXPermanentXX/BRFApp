...
exports.input = function input (props) {
  ...
  return html`
    <label class="${className('Form-item', { 'Form-item--required': props.required, [props.class]: props.class })}">
...
exports.select = function (props) {
  ...
  return html`
    <div class="${className('Form-item Form-item--select', { 'Form-item--required': props.required, [props.class]: props.class })}">
...
exports.checkbox = function checkbox (props) {
  ...
  return html`
    <label class="${className('Form-item Form-item--toggle', { 'Form-item--required': props.required, [props.class]: props.class })}" onselectstart=${event => event.preventDefault()}>

  ...
  render(cooperative, state, emit) {
    ...
    const onsubmit = event => {
      const data = pick(Object.assign({}, cooperative, this.props), [
        'needUpdate', 'name', 'numOfApartments', 'yearOfConst', 'area', 'email',
        'ventilationType', 'incHouseholdElectricity', 'hasLaundryRoom',
        'hasGarage', 'hasCharger', 'hasEnergyProduction', 'hasRepresentative',
